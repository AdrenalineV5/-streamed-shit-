...
AddEventHandler("consumables:client:UseCigarette", function()
    QBCore.Functions.Progressbar("smoke_joint", "Lighting Smoke..", 1500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:Usebeer')
AddEventHandler('consumables:client:Usebeer', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
    }, {}, {}, {}, function() -- Done
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["beer"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
...
RegisterNetEvent('consumables:client:Usewhiskey')
AddEventHandler('consumables:client:Usewhiskey', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
...
RegisterNetEvent('consumables:client:Usevodka')
AddEventHandler('consumables:client:Usevodka', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
...
RegisterNetEvent('consumables:client:Usewine')
AddEventHandler('consumables:client:Usewine', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["wine"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
...
RegisterNetEvent('consumables:client:Usepinkp')
AddEventHandler('consumables:client:Usepinkp', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["pinkp"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
            TriggerEvent('animations:client:EmoteCommandStop')
...
RegisterNetEvent('consumables:client:Usebutterynipple')
AddEventHandler('consumables:client:Usebutterynipple', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["butterynipple"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
            TriggerEvent('animations:client:EmoteCommandStop')
...
RegisterNetEvent('consumables:client:Usevanillaunicorndrink')
AddEventHandler('consumables:client:Usevanillaunicorndrink', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["vanillaunicorndrink"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
            TriggerEvent('animations:client:EmoteCommandStop')
...
RegisterNetEvent('consumables:client:Useapplemartini')
AddEventHandler('consumables:client:Useapplemartini', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["applemartini"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
            TriggerEvent('animations:client:EmoteCommandStop')
...
RegisterNetEvent('consumables:client:Usewhiskeyonice')
AddEventHandler('consumables:client:Usewhiskeyonice', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["whiskeyonice"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
            TriggerEvent('animations:client:EmoteCommandStop')
...
RegisterNetEvent('consumables:client:usejunemilk')
AddEventHandler('consumables:client:usejunemilk', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        QBCore.Functions.Notify("You feel a warm, lumpy substance slide down your throat","success",5000 )
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
            TriggerEvent('animations:client:EmoteCommandStop')
...
RegisterNetEvent('consumables:client:Usevodkapineapple')
AddEventHandler('consumables:client:Usevodkapineapple', function()
    QBCore.Functions.Progressbar("drink_something", "supping", 500, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["vodkapineapple"], "remove")
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            TriggerEvent('animations:client:EmoteCommandStart', {"drink"})
            Wait(15000)
            TriggerEvent('animations:client:EmoteCommandStop')
...
AddEventHandler('consumables:client:ifak', function()
    QBCore.Functions.Progressbar("use_ifak", "Applying IFAK", 2000, false, true, {
        ...
        TriggerServerEvent(hashes['RemoveItem'], "ifak", 1)
...
AddEventHandler("consumables:client:UseArmor", function()
    QBCore.Functions.Progressbar("use_armor", "Putting on the body armour..", 5000, false, true, {
        ...
        TriggerServerEvent(hashes['RemoveItem'], "armor", 1)
...
AddEventHandler("consumables:client:UseHeavyArmor", function()
    ...
    QBCore.Functions.Progressbar("use_heavyarmor", "Putting on body armour..", 5000, false, true, {
        ...
        TriggerServerEvent(hashes['RemoveItem'], "heavyarmor", 1)
        SetPedArmour(ped, 100)
    end)
end)
...
AddEventHandler("consumables:client:ResetArmor", function()
    ...
    if currentVest ~= nil and currentVestTexture ~= nil then
        QBCore.Functions.Progressbar("remove_armor", "Removing the body armour..", 2500, false, true, {
            ...
            TriggerServerEvent(hashes['AddItem'], "heavyarmor", 1)
        end)
    else
...
AddEventHandler("consumables:client:DrinkAlcohol", function(itemName)
    ...
    QBCore.Functions.Progressbar("snort_coke", "Drinking liquor..", math.random(3000, 6000), false, true, {
        ...
        TriggerServerEvent(hashes['RemoveItem'], itemName, 1)
...
AddEventHandler("consumables:client:Cokebaggy", function()
    ...
    QBCore.Functions.Progressbar("snort_coke", "Quick sniff..", math.random(5000, 8000), false, true, {
        ...
        TriggerServerEvent(hashes['RemoveItem'], "cokebaggy", 1)
...
RegisterNetEvent("consumables:client:spicebaggy")
AddEventHandler("consumables:client:spicebaggy", function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_coke", "Quick sniff..", math.random(5000, 8000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        ...
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent(hashes['RemoveItem'], "spicebaggy", 1)
...
AddEventHandler("consumables:client:Crackbaggy", function()
    ...
    QBCore.Functions.Progressbar("snort_coke", "Smoking crack..", math.random(7000, 10000), false, true, {
        ...
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent(hashes['RemoveItem'], "crack_baggy", 1)
...
AddEventHandler('consumables:client:EcstasyBaggy', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Pops Pills", 3000, false, true, {
        ...
        TriggerServerEvent(hashes['RemoveItem'], "xtcbaggy", 1)
...
isEatingHot = false
RegisterNetEvent("consumables:client:EatHot",function()
    local count = 0
    isEatingHot = true
   
    Citizen.CreateThread(function()
        while isEatingHot do
            Wait(0)
            SetEntityProofs(PlayerPedId(),false,true,0,0,0,0,0,1,0)
        end
    end)
    Citizen.CreateThread(function()
        while isEatingHot do
            ...
            SetEntityProofs(PlayerPedId(),false,false,0,0,0,0,0,1,0)
        end
    end)
...
RegisterNetEvent("consumables:client:Dinospeed")
AddEventHandler("consumables:client:Dinospeed", function()
    DinoSnackspeed()
end)

RegisterNetEvent("consumables:client:Dinostress")
AddEventHandler("consumables:client:Dinostress", function()
    TriggerServerEvent(hashes['RemoveItem'], "dino_snackstress", 1)
    DinoSnackstress()
end)

-- RegisterNetEvent("consumables:client:Dinotrip")
-- AddEventHandler("consumables:client:Dinotrip", function()
    -- TriggerServerEvent(hashes['RemoveItem'], "dino_snacktrip", 1)
    -- EcstasyEffect()
	-- CrackBaggyEffect()
	-- AlienEffect()
-- end)
...
function DinoSnackstress()
    TriggerServerEvent('hud:Server:RelieveStress', math.random(48, 65))
end
...
AddEventHandler("consumables:client:Dinotrip", function()
    TriggerServerEvent(hashes['RemoveItem'], "dino_snacktrip", 1)
    EcstasyEffect()
	TriggerEvent("mtmc-acid:client:badtrip")
	AlienEffect()
	Wait(5000)
