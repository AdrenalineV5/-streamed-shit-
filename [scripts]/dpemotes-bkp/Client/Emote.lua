...
RegisterCommand('keithstone', function(source, args, raw)
...
RegisterNetEvent('animations:client:EmoteCommandStop')
AddEventHandler('animations:client:EmoteCommandStop', function(args)
  EmoteCancel()
end)
