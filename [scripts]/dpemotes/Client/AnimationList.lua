...
-----------------------------------------------------------------------------------------------------------
   ...
   ["canival"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger_fp", "Eat", AnimationOptions =
{
    Prop = "ltyheart",
    PropBone = 18905,
    PropPlacement = {0.12, 0.028, 0.001, 10.0, 175.0},
...
["canival2"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger_fp", "Eat", AnimationOptions =
{
    Prop = "ltyear",
    PropBone = 18905,
    PropPlacement = {0.12, 0.028, 0.001, 10.0, 175.0},
...
["canival3"] = {"amb@code_human_wander_eating_donut@male@idle_a", "idle_c", "Eat", AnimationOptions =
{
    Prop = "ltyarm",
    PropBone = 28422,
    --PropPlacement = {0.12, 0.028, 0.001, 10.0, 175.0},
...
["canival4"] = {"amb@code_human_wander_eating_donut@male@idle_a", "idle_c", "Eat", AnimationOptions =
{
    Prop = "ltyleg",
    PropBone = 28422,
    --PropPlacement = {0.12, 0.028, 0.001, 10.0, 175.0},
...
["canival5"] = {"amb@code_human_wander_eating_donut@male@idle_a", "idle_c", "Eat", AnimationOptions =
{
    Prop = "ltyleg2",
    PropBone = 28422,
    --PropPlacement = {0.12, 0.028, 0.001, 10.0, 175.0},
...
["canival6"] = {"amb@code_human_wander_eating_donut@male@idle_a", "idle_c", "Eat", AnimationOptions =
{
    Prop = "ltyarm2",
    PropBone = 28422,
    --PropPlacement = {0.12, 0.028, 0.001, 10.0, 175.0},
